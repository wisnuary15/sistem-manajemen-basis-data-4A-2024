...
CALL tampilBiodata(1234, 'Fairuz', 'Jalan Telang Indah', 098765, 'L', 'Tidur', '2004-10-11');
...
CREATE PROCEDURE HapusAnggotaLa(IN anggota_id VARCHAR(10))
BEGIN
    DECLARE Kondisi INT;
    DECLARE isFemale INT;
    ...
    ELSEIF isFemale > 0 THEN
        SELECT 'Data anggota dengan id tersebut adalah perempuan. Tidak dapat menghapus.' AS result;
    ELSE
...
CALL HapusAnggotaLa('A003');
CALL HapusAnggotaLa('A010');
